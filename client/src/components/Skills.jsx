...
const Skills = () => {
  ...
  const skills = [
    ...
    { name: 'Tailwind CSS', level: 95, category: 'Frontend', color: '#38B2AC' },
    { name: 'HTML5/CSS3', level: 95, category: 'Frontend', color: '#E34F26' },
    { name: 'Context API', level: 88, category: 'Frontend', color: '#61DAFB' },
    { name: 'Node.js', level: 88, category: 'Backend', color: '#339933' },
    { name: 'Express.js', level: 85, category: 'Backend', color: '#000000' },
    { name: 'RESTful APIs', level: 90, category: 'Backend', color: '#000000' },
    ...
    { name: 'MongoDB', level: 87, category: 'Databases', color: '#47A248' },
    { name: 'MySQL', level: 80, category: 'Databases', color: '#4479A1' },
    { name: 'Docker', level: 82, category: 'Tools', color: '#2496ED' },
    { name: 'Git/GitHub', level: 92, category: 'Tools', color: '#F05032' },
    { name: 'Postman', level: 88, category: 'Tools', color: '#FF6C37' },
    { name: 'CI/CD', level: 75, category: 'Tools', color: '#3E96D7' },
  ]
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-2 md:gap-3">
            {['React', 'Node.js', 'Python','Django', 'FastAPI', 'Express', 'MongoDB', 'PostgreSQL', 'Redis', 'Docker','Git', 'CI/CD', 'REST API'].map((tech, index) => (
              <motion.div
                key={tech}
