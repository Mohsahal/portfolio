        ...
        >
          ...
          <div className="max-w-4xl mx-auto space-y-5 md:space-y-7">
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-primary-100 leading-relaxed font-light">
              Full Stack Developer (MERN Stack) with hands-on experience building responsive and scalable web applications. Currently pursuing 
              <span className="text-primary-400 font-bold bg-primary-500/10 px-2 py-1 rounded"> B.E in Information Science at Yenepoya Institute of Technology</span> with a CGPA of <span className="text-primary-400 font-bold">7.2</span>.
            </p>
            <p className="text-base sm:text-lg md:text-xl text-primary-200 leading-relaxed font-light">
              I specialize in developing <span className="text-primary-400 font-semibold">RESTful APIs</span>, implementing <span className="text-primary-400 font-semibold">secure JWT authentication</span>, 
              and designing maintainable backend architectures. My focus is on delivering production-ready applications with 
              <span className="text-primary-400 font-semibold"> clean code, modern UI design, and containerized deployment</span>.
            </p>
            <p className="text-base sm:text-lg md:text-xl text-primary-300 italic font-light border-l-4 border-primary-500 pl-4 py-2">
              "Passionate about writing clean, efficient code and delivering user-friendly solutions."
            </p>
          </div>
        </motion.div>
