    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center min-h-screen py-20">
        <div className="w-full max-w-5xl">
          ...
          >
            Full Stack Developer focused on building high-performance web applications using modern full-stack technologies. Experienced in developing robust, user-friendly solutions with clean architecture and industry best practices.
          </motion.p>
